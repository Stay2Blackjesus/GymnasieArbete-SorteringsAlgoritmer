...
def startAverage(n,v,r):
    print(f'Running With {v} digits:')
    bbl = 0
    ins = 0
    sel = 0
    mer = 0
    ...
    print(f'bubbleSort    = {round(B,3)}ms')
    print(f'insertionSort = {round(I,3)}ms')
    print(f'selectionSort = {round(S,3)}ms')
    print(f'mergeSort     = {round(M,3)}ms')
    print(f'quickSort     = {round(Q,3)}ms')

input("Press Enter to Start...")
startAverage(100,100,10)
